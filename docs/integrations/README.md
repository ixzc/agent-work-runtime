...
| Cursor | L1 | [Cursor note](cursor.md) | `.cursor/mcp.json` vs user file, `type: stdio`, Cloud Agent HTTPS vs loopback, dated Agent Window check |
...
Cursor already has an [L1 note](cursor.md) for MCP merge paths.
